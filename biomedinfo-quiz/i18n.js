/* Biomedical Informatics Quiz · i18n
 * 與 ../i18n.js 同邏輯：
 * - localStorage key 'biomedinfo_lang'（與教學共用，切換能跨頁同步）
...
(function(){
  ...
  const STR = {
    appTitle:        { zh:"🔬 生醫資訊研究技術 互動考題", en:"🔬 BioMed Informatics Interactive Quiz" },
    ...
    rangeAll:        { zh:"全部 14 個章節", en:"All 14 chapters" },
    ...
    quizAllChapters: { zh:"生醫資訊研究技術 互動考題（全部章節）", en:"BioMed Informatics Interactive Quiz (All Chapters)" },
    quizErrataTitle: { zh:"生醫資訊研究技術 互動考題", en:"BioMed Informatics Interactive Quiz" },
